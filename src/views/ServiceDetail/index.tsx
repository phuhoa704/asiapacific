        ...
        <div>
            ...
            <div className="w-full">
                <div className="w-11/12 lg:w-8/12 m-auto py-12">
                    ...
                    <div className="mt-4" ref={(el: any) => el && divs.current.push(el)} dangerouslySetInnerHTML={{ __html: servicesById.content ? translateContent(language, JSON.parse(servicesById.content), listLangs) : '' }}></div>
                </div>
            </div>
        </div>
    );
