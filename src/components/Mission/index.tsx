        ...
        <section className="w-full p-6">
            <div className="w-11/12 m-auto">
                <div className="w-1/2 flex flex-col items-center m-auto">
                    ...
                    <div className="text-[#ae73db] font-medium text-3xl" ref={(el: any) => el && divs.current.push(el)}>Our Mission</div>
                ...
                <div className="flex justify-evenly">
                    <div className={`group p-6 shadow-2xl rounded h-[300px] bg-cover bg-center ${hover === 1 ? 'bg-[#4287f5]' : 'bg-mission'} flex flex-col justify-between transition-all`} onMouseEnter={() => setHover(1)} onMouseLeave={() => setHover(0)} ref={(el: any) => el && divs.current.push(el)}>
                    ...
                    <div className={`group p-6 shadow-2xl rounded h-[300px] bg-cover bg-center ${hover === 2 ? 'bg-[#4287f5]' : 'bg-mission'} flex flex-col justify-between transition-all`} onMouseEnter={() => setHover(2)} onMouseLeave={() => setHover(0)} ref={(el: any) => el && divs.current.push(el)}>
                        <div className='rounded-full bg-white w-[50px] h-[50px] p-4 flex items-center justify-center text-[#223cd1] text-lg opacity-0 group-hover:opacity-100'>
                            <i className="fa-solid fa-chart-column"></i>
                        </div>
                        <div>
