...
const ContactCard:React.FC<Props> = ({ title, address }) => {
    return (
        <div className="group relative">
            <div className="absolute hidden bg-[#86b4cf] group-hover:bg-[#b07ee6] lg:flex items-center justify-center rounded-tl-[12px] md:rounded-tl-[24px] rounded-br-[12px] md:rounded-br-[24px] p-2 md:p-2 w-[30px] md:w-[30px] lg:w-[50px] h-[30px] lg:h-[50px] top-[30px] md:top-[30px] left-[-10px] md:left-[-30px]">
