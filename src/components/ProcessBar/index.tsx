    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <div className="h-1.5 w-full bg-neutral-200 dark:bg-neutral-600 rounded relative">
                ...
                <span style={{ left: `${percent}%` }} className={`flex items-center justify-center w-8 h-8 absolute rounded-full -top-4 bg-[#1f1e1d] text-xs font-medium text-white`}>{percent}%</span>
            </div>
        </div>
    );
}
