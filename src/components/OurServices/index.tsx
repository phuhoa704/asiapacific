        ...
        <section className="w-full p-6">
            <div className="w-11/12 m-auto">
                <div className="w-1/2 flex flex-col items-center m-auto">
                    ...
                    <div className="text-[#ae73db] font-medium text-3xl">Our Services</div>
                    <p className="text-[11px] text-[#1d1e1f] mt-4 mb-4 text-center">The company provides the following services in the areas of immigration, taxation, and property consultancy, focusing on Japan, Vietnam, and Hong Kong.</p>
                </div>
                <div className="grid grid-cols-6 gap-4">
                    {services.map(s => (
                        <div className="group text-[#223cd1]" key={s.id}>
